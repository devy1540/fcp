...
func (s *Server) dashboardSnapshot() dashboardResponse {
	services := []dashboardService{
		...
		{ID: "firestore", Name: "Firestore", Provider: "GCP", Description: "저장된 문서 메타데이터", Status: "READY", Verification: dashboardVerificationFor("firestore", "SDK", "Firestore Go v1.24.0 · PODO Kotlin/Java"), Resources: []dashboardResource{}},
		...
		{ID: "fcm", Name: "FCM", Provider: "GCP", Description: "외부 발송 없이 캡처된 요청", Status: "READY", Verification: dashboardVerificationFor("fcm", "CONTRACT", "PODO notification FCM HTTP v1 경로"), Resources: []dashboardResource{}},
		{ID: "metadata", Name: "Compute Metadata", Provider: "GCP", Description: "로컬 프로젝트와 서비스 계정 identity", Status: "READY", Verification: dashboardVerificationFor("metadata", "CONTRACT", "PODO Metadata REST · JWKS 경로"), Resources: []dashboardResource{}},
